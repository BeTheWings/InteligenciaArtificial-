# -*- coding: utf-8 -*-
"""
Created on Fri Apr 23 11:20:04 2021
...
x_train,x_test,y_train,y_test=train_test_split(iris.data,iris.target,train_size=0.6)
...
print("하이퍼 매개변수 최적화에 걸린시간은",end-start,"초입니다.")
